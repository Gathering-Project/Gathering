...
import nbc_final.gathering.domain.member.dto.request.MemberRequestDto;
import nbc_final.gathering.domain.member.dto.request.MemberRoleUpdateRequestDto;
...
public class MemberController {
    ...
    public ResponseEntity<ApiResponse<MemberResponseDto>> requestToJoin(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "가입 신청이 완료되었습니다.", response));
    }
